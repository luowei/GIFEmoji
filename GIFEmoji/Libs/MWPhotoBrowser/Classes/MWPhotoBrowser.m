...
- (void)viewDidLoad {
    ...
    if (self.displayNavArrows) {
        UIImage *previousButtonImage = [UIImage imageNamed:@"UIBarButtonItemArrowLeft" inBundleNamed:@"MWPhotoBrowser"];
        UIImage *nextButtonImage = [UIImage imageNamed:@"UIBarButtonItemArrowRight" inBundleNamed:@"MWPhotoBrowser"];
...
- (void)performLayout {
    ...
    if (_enableGrid) {
        hasItems = YES;
        [items addObject:[[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"UIBarButtonItemGrid" inBundleNamed:@"MWPhotoBrowser"] style:UIBarButtonItemStylePlain target:self action:@selector(showGridAnimated)]];
    } else {
	...
	for (NSUInteger index = (NSUInteger)iFirstIndex; index <= (NSUInteger)iLastIndex; index++) {
		if (![self isDisplayingPageForIndex:index]) {
            ...
            if (page.displayingVideo) {
                ...
                [playButton setImage:[UIImage imageNamed:@"PlayButtonOverlayLarge" inBundleNamed:@"MWPhotoBrowser"] forState:UIControlStateNormal];
                [playButton setImage:[UIImage imageNamed:@"PlayButtonOverlayLargeTap" inBundleNamed:@"MWPhotoBrowser"] forState:UIControlStateHighlighted];
            ...
            if (self.displaySelectionButtons) {
                ...
                [selectedButton setImage:[UIImage imageNamed:@"ImageSelectedOff" inBundleNamed:@"MWPhotoBrowser"] forState:UIControlStateNormal];
                ...
                if (self.customImageSelectedIconName) {
                    ...
                    selectedOnImage = [UIImage imageNamed:@"ImageSelectedOn" inBundleNamed:@"MWPhotoBrowser"];
                }
...
//                    initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(selectPhotoDone)];
        } else {
            NSString *photosText;
            if (numberOfPhotos == 1) {
...
////选择一张照片完成
//- (void)selectPhotoDone {
//    if([_delegate respondsToSelector:@selector(selectPhotoDoneInPhotoBrowser:)]){
//        [_delegate selectPhotoDoneInPhotoBrowser:self];
//    }
//}
...
- (void)actionButtonPressed:(id)sender {
    ...
    if ([self numberOfPhotos] > 0 && [photo underlyingImage]) {
        ...
        if ([self.delegate respondsToSelector:@selector(photoBrowser:actionButtonPressedForPhotoAtIndex:)]) {
            ...
            NSMutableArray *items = [@[[photo underlyingImage]] mutableCopy];
            if (photo.caption) {
