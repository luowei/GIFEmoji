...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        UIImage *videoIndicatorImage = [UIImage imageNamed:@"VideoOverlay" inBundleNamed:@"MWPhotoBrowser"];
        ...
        [_selectedButton setImage:[UIImage imageNamed:@"ImageSelectedSmallOff" inBundleNamed:@"MWPhotoBrowser"] forState:UIControlStateNormal];
        [_selectedButton setImage:[UIImage imageNamed:@"ImageSelectedSmallOn" inBundleNamed:@"MWPhotoBrowser"] forState:UIControlStateSelected];
...
- (void)showImageFailure {
    ...
    if (![_photo respondsToSelector:@selector(emptyImage)] || !_photo.emptyImage) {
        if (!_loadingError) {
            ...
            _loadingError.image = [UIImage imageNamed:@"ImageError" inBundleNamed:@"MWPhotoBrowser"];
