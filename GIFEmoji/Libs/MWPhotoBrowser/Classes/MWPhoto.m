...
- (void)_performLoadUnderlyingImageAndNotifyWithWebURL:(NSURL *)url {
    @try {
        _webImageDownloadToken =  [[SDWebImageDownloader sharedDownloader] downloadImageWithURL:url
                                                              options:0
...
- (void)cancelAnyLoading {
    if (_webImageDownloadToken != nil) {
        [[SDWebImageDownloader sharedDownloader] cancel:_webImageDownloadToken];
        _loadingInProgress = NO;
    }
